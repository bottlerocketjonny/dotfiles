  ...
  },
  {
    ...
    config = function()
      require('gruvbox').setup {
        -- Customize the line number and sign column colors
        overrides = {
          -- LineNr = { fg = '#fabd2f', bg = '#1d2021' }, -- Line number text and background color
          SignColumn = { bg = '#282828' }, -- Sign column background color
        },
      }
...
-- Dont really like these but leaving here anyways
--
-- {
